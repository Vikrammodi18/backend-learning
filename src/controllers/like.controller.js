...
const toggleVideoLike = asyncHandler(async (req, res) => {
  ...
  const videoLikedByUser = await Like.findOne({
  ...
  if (videoLikedByUser) {
    ...
    return res.status(200).json(new ApiResponse(200, {}, "unlike"));
  } else {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { liked }, "video is liked"));
  }
});
...
const toggleTweetLike = asyncHandler(async (req, res) => {
  ...
  if (isTweetLike) {
    ...
    return res.status(200).json(new ApiResponse(200, {}, "dislike tweet"));
  } else {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { tweetLike }, "like a tweet"));
  }
});
const getLikedVideos = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, likedVideos, "videos details fetched successfully")
    );
});
module.exports = {
  toggleVideoLike,
